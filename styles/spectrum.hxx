...
namespace ImGui {
    namespace Spectrum {
        ...
        const unsigned int TEXT_COLOR = Color(0xdbcfb6);
        const unsigned int TEXT_COLOR_DISABLED = Color(0xffffff);
        const unsigned int BG_COLOR = Color(0xfeefd0);
        const unsigned int BUTTON_COLOR = Color(0x692a2a);
        const unsigned int BUTTON_HOVERED = Color(0x853838);


        const unsigned int GRAY50 = Color(0xFFFFFF);
        const unsigned int GRAY75 = Color(0x532D22);
        ...
        const unsigned int TEXT_COLOR = Color(0xCDCDCD);
        const unsigned int TEXT_COLOR_DISABLED = Color(0xffffff)
        const unsigned int BG_COLOR = Color(0x323232);
        const unsigned int BUTTON_COLOR = Color(0x532D22);
        const unsigned int BUTTON_HOVERED = Color(0x252525);
